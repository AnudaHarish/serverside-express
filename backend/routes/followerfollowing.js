...
router.get("/filter/followers", UserFollowersController.getFollowingsByUsername);
//get following list
router.get("/followings", UserFollowersController.getFollowingList);
router.get("/filter/followings", UserFollowersController.getFollowersByUsername)
//follow user
